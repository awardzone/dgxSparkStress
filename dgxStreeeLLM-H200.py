'''
Per caricare un modello che saturi una GPU da 140 GB di VRAM senza dover scaricare 
...
saturando immediatamente i nodi  e causando un crash di sistema 
...
# =====================================================================
# CONFIGURAZIONE STRUTTURATA PER GPU DA 140GB
# =====================================================================
...
BATCH_SIZE = 8          # Numero di sequenze elaborate contemporaneamente
SEQUENCE_LENGTH = 4096   # Lunghezza del contesto (più è alto, più stressa la memoria dei Tensor Core)  Puoi provare 8192 se con 8 non va in OOM
...
def stress_gpu_with_llm(gpu_id):
    ...
    try:
        ...
        # Ottimizzazione parametri per calzare a pennello su 140GB (Target ~125GB occupati all'avvio)
        config.num_hidden_layers = 76  # Adattiamo leggermente il numero di layer se necessario
        ...
        print(f"[GPU {gpu_id}] Modello caricato! VRAM Occupata stabilmente: {vram_used:.2f} GB / 140 GB")
...
if __name__ == '__main__':
    ...
    print(f"\n=======================================================")
    print(f"   LLM BRUTAL STRESS TEST - NVIDIA H200 (140GB VRAM)     ")
    print(f"=======================================================")
